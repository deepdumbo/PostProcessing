...
% output_filename = '/home/valery/Reseau/Imagerie/For_Valery/TestRecoKylian/ExVivo/FID/data_39_cut.h5';


acquisition_path='/home/valery/Reseau/Imagerie/For_Valery/TestRecoKylian/InVitro/16/'
output_filename = '/home/valery/Reseau/Imagerie/For_Valery/TestRecoKylian/InVitro/FID/data_16_cut.h5';
...
[header] = fill_the_flexible_xml_header_cut(ex);
...
number_of_lines=number_of_lines/10*3; %%modif special


test_data_for_acqp_1=data_for_acqp(:,:,1:10:end);
test_data_for_acqp_2=data_for_acqp(:,:,2:10:end);
test_data_for_acqp_3=data_for_acqp(:,:,3:10:end);

test_data_for_acqp_total(:,:,1:3:number_of_lines)=test_data_for_acqp_1;
test_data_for_acqp_total(:,:,2:3:number_of_lines)=test_data_for_acqp_2;
test_data_for_acqp_total(:,:,3:3:number_of_lines)=test_data_for_acqp_3;

%% fill the fixed data structure

[ idx, flag ] = fill_the_idx_cut( header , ex);
...
for acqno = 1:number_of_lines
    ...
    % fill the data
    acqblock.data{acqno} = squeeze(test_data_for_acqp_total(:,:,acqno));
...
for s = 1:4
    subplot(2,2,s)
    temp=squeeze(data_for_acqp(:,6,s:4:end));
