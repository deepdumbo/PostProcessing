...
for numb = 1:size(n_reco,2)
    ...
    acquisition_path    = ['/home/', str_user, '/mount/Imagerie/For_Kylian/Dixon/Validation/RawData/Ex_Vivo/2D/No_Grappa/20180122/Coeur_CC_seq_Julie/',num2str(n_reco(numb))];
    output_tmp          = ['/home/', str_user, '/Dicom/DIXON/Validation/RecoData/Ex_Vivo/2D/No_Grappa/20180122/Coeur_CC_seq_Julie/',num2str(n_reco(numb))];
