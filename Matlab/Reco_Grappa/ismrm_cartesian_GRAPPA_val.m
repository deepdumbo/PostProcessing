function [img,gmap,snr,snr_pseudo,gmap_pseudo,noise_psf_pseudo] = ismrm_cartesian_GRAPPA_val(inp,samp_mat, acc_factor,csm,replicas, coil_combine_mode)
%
...
[unmix, gmap] = ismrm_calculate_grappa_unmixing_val(inp, [5 4], acc_factor, (samp_mat > 1),csm,[], true,  coil_combine_mode);
