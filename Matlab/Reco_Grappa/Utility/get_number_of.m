function [ number_of_slices, number_of_coils  , number_of_repetitions, number_of_contrasts, number_of_phase, number_of_average , number_of_segments] = get_number_of( hdr )
