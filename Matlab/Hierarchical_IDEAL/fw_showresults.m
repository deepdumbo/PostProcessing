%% 2018/04/23 : K. HALIOT 
%   Removed 'Replace' param in subplot() : caused error in display
...
function fw_showresults(handles, varargin)
  ...
  try
    ...
    if isfield(handles.outParams,'water'),
      ...
      h=subplot(2,4,1); h2=imagesc(abs(handles.outParams.water(:,:,handles.z))','Parent',h);title(h,{'WATER image',sprintf('z = %d',handles.z)},'vertical','bottom'); ylabel(h,'Single-peak'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
      h=subplot(2,4,2); h2=imagesc(abs(handles.outParams.fat(:,:,handles.z))','Parent',h);title(h,{'FAT image',sprintf('z = %d',handles.z)},'vertical','bottom'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
      h=subplot(2,4,3); h2=imagesc(abs(handles.outParams.r2starmap(:,:,handles.z))','Parent',h);title(h,{'R2*',sprintf('z = %d',handles.z)},'vertical','bottom'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
      h=subplot(2,4,4); h2=imagesc(angle(handles.outParams.phasemap(:,:,handles.z))','Parent',h);title(h,{'Phase map',sprintf('z = %d',handles.z)},'vertical','bottom'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
      if isfield(handles,'outParamsMP'),
        h=subplot(2,4,5); h2=imagesc(abs(handles.outParamsMP.species(1).amps(:,:,handles.z)'));title(h,{'WATER image',sprintf('z = %d',handles.z)},'vertical','bottom'); ylabel(h,'Multi-peak'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
        set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
        h=subplot(2,4,6); h2=imagesc(abs(handles.outParamsMP.species(2).amps(:,:,handles.z)'));title(h,{'FAT image',sprintf('z = %d',handles.z)},'vertical','bottom'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
        set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
        h=subplot(2,4,7);
      ...
      drawnow;
      h=subplot(2,4,8); h2=imagesc(abs(handles.outParams.fiterror(:,:,handles.z))','Parent',h);title(h,{'Fitting Error',sprintf('z = %d',handles.z)},'vertical','bottom'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
    else
      % New algorithm with multi-peak results only
      for n=1:numel(handles.outParams.species),
        h=subplot(2,numel(handles.outParams.species),n); 
...
%      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
      h=subplot(2,3,4); h2=imagesc(abs(handles.outParams.r2starmap(:,:,handles.z))','Parent',h);title(h,{'R2*',sprintf('z = %d',handles.z)},'vertical','bottom'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
      h=subplot(2,3,5); h2=imagesc(angle(handles.outParams.phasemap(:,:,handles.z))','Parent',h);title(h,{'Phase map',sprintf('z = %d',handles.z)},'vertical','bottom'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
      h=subplot(2,3,6); h2=imagesc(abs(handles.outParams.fiterror(:,:,handles.z))','Parent',h);title(h,{'Fitting Error',sprintf('z = %d',handles.z)},'vertical','bottom'); h3=colorbar('peer',h); axis(h,'image'); drawnow;
      set(h2,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')'); set(h3,'ButtonDownFcn','fw_showresults(guidata(gcbo),''mouse'')');
    end
    clear h h2 h3;
  end    
